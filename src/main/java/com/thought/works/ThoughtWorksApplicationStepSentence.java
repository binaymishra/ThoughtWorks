 ...
 */
public class ThoughtWorksApplicationStepSentence {
    ...
    public static void main(String[] args) {
        ...
        TwResponseSentence twResponseSentence = new TwResponseSentence();
        twResponseSentence.sentenceCount = count;

        String postJson = GSON.toJson(twResponseSentence);
